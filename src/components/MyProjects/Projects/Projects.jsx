...
const Projects = () => {
    return (
        <div className="my-16 relative text-white p-4">
                ...
                <div className="w-96 md:w-[600px]">
                    ...
                    <div>
                        ...
                        <ul className="ml-10 text-xl">
                            <li type='disc'>You can see and ordered all food of our restaurant</li>
                            <li type='disc'>You can register and add food to restaurant</li>
                            <li type='disc'>You can choose breakfast Lunch or Dinner from our restaurant site</li>
                            <li type='disc'>You can see your added food and also update your added food</li>
                            <li type='disc'>You can see your ordered food also and if you need you can delete your ordered food</li>
                        </ul>
                    </div>
                    <div>
                        <h4 className="text-xl font-medium">Technology That I use :</h4>
                        <ul className="ml-10 text-xl">
                            <li type='disc'>Font-End : (React, Tailwind, DaisyUI, JavaScript,Firebase)</li>
                            <li type='disc'>Back-End : (MongoDB, Express.js, Node.js)</li>
                        </ul>
                    </div>
            ...
            <div className="flex flex-col lg:flex-row justify-between mt-5 border-b-4 pb-7">
                <div className="w-96 md:w-[600px]">
                    ...
                    <div>
                        <h4 className="text-xl font-medium">Projects Feature :</h4>
                        <ul className="ml-10 text-xl">
                            <li type='disc'>3 different dashboard created based on user type(Admin,DeliveryMan,User)</li>
                            <li type='disc'>You can login as user or delivery man</li>
                            <li type='disc'>You can login and parcel your product</li>
                            <li type='disc'>you can see parcel status condition</li>
                            <li type='disc'>you can give feedack for delivery man .etc...</li>
                        </ul>
                    </div>
                    <div>
                        <h4 className="text-xl font-medium">Technology That I use :</h4>
                        <ul className="ml-10 text-xl">
                            <li type='disc'>Font-End : (React, Tailwind, DaisyUI, JavaScript,Firebase)</li>
                            <li type='disc'>Back-End : (MongoDB,Mongoose, Express.js, Node.js)</li>
                        </ul>
                    </div>
            ...
            <div className="flex flex-col lg:flex-row justify-between mt-5 border-b-4 pb-7">
                <div className="w-96 md:w-[600px]">
                    ...
                    <div>
                        <h4 className="text-xl font-medium">Projects Feature :</h4>
                        <ul className="ml-10 text-xl">
                            <li type='disc'>You can see brand products of Technology and Electronics.</li>
                            <li type='disc'>You can create account and buy products.</li>
                            <li type='disc'>If you logged in you can add and update products</li>
                            <li type='disc'>You can Troggle dark and light theme</li>
                            <li type='disc'>You can see Latest Products of top brands</li>
                        </ul>
                    </div>
                    <div>
                        <h4 className="text-xl font-medium">Technology That I use :</h4>
