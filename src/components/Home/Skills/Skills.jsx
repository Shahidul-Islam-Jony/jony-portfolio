...
const Skills = () => {
    return (
        <div id='skills' className='grid grid-cols-1 md:grid-cols-3 gap-2 my-7'>
            <div className="card">
                <div className='content w-full'>
                    <div className="-mt-20">
                        <div className='flex justify-center'>
                        <figure><Image src={work} width={100} height={100} className='border-4 border-white rounded-full p-4' alt="working" /></figure>
                        </div>
            ...
            <div className="card">
                <div className='content w-full'>
                    ...
                    <div className="mt-4">
                        <div className='flex justify-center'>
                            <Image src={book} width={100} height={100} className='border-4 border-white rounded-full p-4' alt="education" />
                        </div>
                        <div className="mt-5">
            ...
            <div className="card">
                <div className='content w-full'>
                    ...
                    <div className="mt-1">
                        <div className='flex justify-center'>
                        <figure><Image width={1000} height={100} src={skill} className='border-4 w-[100px] h-[100px] border-white rounded-full p-4' alt="Skills" /></figure>
                        </div>
                        <div className="mt-5">
